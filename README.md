...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yd88xbo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yd88xbo.containers.anotherwebservice.com/
...
```
git clone git@github.com:12to12tech/container-yd88xbo.git
cd container-yd88xbo
```
...
```
docker attach container-yd88xbo
```
